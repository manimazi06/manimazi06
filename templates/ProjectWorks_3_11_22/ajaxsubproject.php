...
<tr class="delete_docdetails_class_<?php echo $id ?> present_row">
   ...
   <td align="right"><?php echo  number_format((float)$projectWorkSubdetail['rough_cost'], 2, '.', ''); ?></td>
    ...
    <?php echo $this->Html->link(__('<i class="fa fa-plus"></i>Add Units'),['controller'=>'ProjectwiseQuartersDetails','action' => 'projectwisequarterdetailsadd',$projectWorkSubdetail['project_work_id'],$projectWorkSubdetail['id']], ['escape' => false, 'class' => 'btn btn-outline-danger btn-sm','target'=>'_blank']); ?><br><br>
