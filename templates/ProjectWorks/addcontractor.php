								...
								<tbody>
									<?php $sno = 1;
										...
										<tr class="odd gradeX">
											...
											<td class="title" style="text-align:center;"><?php echo ($abstract_subdetail['item_code'] != 0)?$abstract_subdetail['item_code']:$abstract_subdetail['new_item_code'] ?></td>
											<td class="title"><?php echo ($abstract_subdetail['item_description'])?$abstract_subdetail['item_description']:$abstract_subdetail['new_item_description'] ?></td>
