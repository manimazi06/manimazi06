...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $technicalSanction->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $technicalSanction->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="technicalSanctions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Technical Sanction') ?></legend>
                <?php
