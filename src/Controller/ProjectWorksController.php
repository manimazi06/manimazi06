...
class ProjectWorksController extends AppController
{
	...
	public function add()
	{
		...
		$this->ProjectStatuses = $this->fetchTable('ProjectStatuses');
		$this->Districts = $this->fetchTable('Districts');
		$this->Divisions = $this->fetchTable('Divisions');
		$this->SchemeTypes = $this->fetchTable('SchemeTypes');
		...
		$this->Circles = $this->fetchTable('Circles');
	...
	public function administrativesanctionadd()
	{
		...
		$this->Departments = $this->fetchTable('Departments');
		$this->FinancialYears = $this->fetchTable('FinancialYears');
		$this->SupervisionCharges = $this->fetchTable('SupervisionCharges');
		...
		if ($this->request->is(['patch', 'post', 'put'])) {
			...
			// echo '<pre>';
			// print_r($approved_project_count);
			// exit();
	...
	{
		$this->viewBuilder()->setLayout('layout');
		$this->ProjectwiseDetailedEstimates=$this->fetchTable('ProjectwiseDetailedEstimates');
		$this->ProjectAdministrativeSanctions=$this->fetchTable('ProjectAdministrativeSanctions');
		$this->ProjectWorkSubdetails=$this->fetchTable('ProjectWorkSubdetails');
		$this->DetailedEstimateApprovalStages=$this->fetchTable('DetailedEstimateApprovalStages');
		$this->Users=$this->fetchTable('Users');
	...
	{
		$this->Materials=$this->fetchTable('Materials');
	...
	public function tenderdetails($id = null, $work_id = null)
	{
		...
		$this->TechnicalSanctions=$this->fetchTable('TechnicalSanctions');
		$this->TenderTypes=$this->fetchTable('TenderTypes');
		$this->TenderStatuses=$this->fetchTable('TenderStatuses');
		$this->ProjectTenderStatusDetails=$this->fetchTable('ProjectTenderStatusDetails');
		$this->Notifications=$this->fetchTable('Notifications');
		$this->Users=$this->fetchTable('Users');
		$this->ProjectwiseAbstractDetails=$this->fetchTable('ProjectwiseAbstractDetails');
	...
	public function addcontractor($id = null, $work_id = null, $tender = null)
	{
		...
		$this->ProjectwiseContractorRateDetails=$this->fetchTable('ProjectwiseContractorRateDetails');
	...
	public function workview($id = null, $work_id = null)
	{
		...
		//$this->=$this->fetchTable('ProjectwiseDetailedEstimates');
		$this->DetailedEstimateApprovalStages=$this->fetchTable('DetailedEstimateApprovalStages');
		$this->PlanningPermissionDetails=$this->fetchTable('PlanningPermissionDetails');
		...
		$this->ProjectwiseAbstractDetails=$this->fetchTable('ProjectwiseAbstractDetails');
		$this->ProjectwiseAbstractSubdetails=$this->fetchTable('ProjectwiseAbstractSubdetails');
		$this->ProjectPlacedToBoardDetails=$this->fetchTable('ProjectPlacedToBoardDetails');
		$this->ProjectwiseDevelopmentWorks=$this->fetchTable('ProjectwiseDevelopmentWorks');
		...
		$this->ProjectwiseAbstractAdditionalDetails=$this->fetchTable('ProjectwiseAbstractAdditionalDetails');
	...
	public function fundrequest($id = null, $work_id = null)
	{
		...
		$this->WorkStages=$this->fetchTable('WorkStages');
		$this->Users=$this->fetchTable('Users');
		$this->ProjectFundRequestStages=$this->fetchTable('ProjectFundRequestStages');
		$this->FundStatuses=$this->fetchTable('FundStatuses');
	...
	public function ajaxprojectfulldetails($id = null, $work_id = null)
	{
		...
		$this->set(compact(
			'projectWork',
			'monitoringDetailscount',
			'monitorings',
			'utilizationCertificatecount',
			...
			'completiondetails',
			'placedtoboardcount',
			'placedtoboarddetails',
			'financialSanctionscount',
			'financialSanctions',
			'technicalcount',
			'technical',
			'$projectWorkSubdetailcount',
			'projectWorkSubdetails',
			'tenders',
			'tenderscount',
	...
	public function planningpermission($id = null, $work_id = null)
	{
		...
		$this->PlanningPermissionDetails=$this->fetchTable('PlanningPermissionDetails');
		$this->ProjectWorkSubdetails=$this->fetchTable('ProjectWorkSubdetails');
		$this->ProjectwiseFloorSubdetails=$this->fetchTable('ProjectwiseFloorSubdetails');
		$this->ProjectwiseFloorDetails=$this->fetchTable('ProjectwiseFloorDetails');
		$this->Notifications=$this->fetchTable('Notifications');
		$this->Users=$this->fetchTable('Users');
		...
		$this->set(compact(
			...
			'work_id',
			'totalunit',
			'projectwisefloorSubdetailcount',
			'projectwisefloorSubdetail',
			'projectwisefloorDetailscount',
	...
	public function funddetails($id = null, $work_id = null)
	{
		...
		$this->ProjectTenderDetails=$this->fetchTable('ProjectTenderDetails');
		$this->TechnicalSanctions=$this->fetchTable('TechnicalSanctions');
		//$this->=$this->fetchTable('IsAmountReceives');
		$this->ProjectFundDetails=$this->fetchTable('ProjectFundDetails');
	...
	public function projectminutedetail($id = null, $work_id = null)
	{
		...
		$this->ProjectMinuteSubdetails=$this->fetchTable('ProjectMinuteSubdetails');
		$this->ProjectMinuteDetails=$this->fetchTable('ProjectMinuteDetails');
...
*/
	...
	{
		$this->ProjectFundRequests=$this->fetchTable('ProjectFundRequests');
		$this->ProjectFundRequestStages=$this->fetchTable('ProjectFundRequestStages');
		$this->ProjectFundRequestDetails=$this->fetchTable('ProjectFundRequestDetails');
		$this->ProjectFundRequestLogs=$this->fetchTable('ProjectFundRequestLogs');
		$this->ProjectFundRequestDetailLogs=$this->fetchTable('ProjectFundRequestDetailLogs');
		$this->ProjectWorks=$this->fetchTable('ProjectWorks');
		$this->Users=$this->fetchTable('Users');
	...
	public function projectabstractadd($id = null, $work_id = null)
	{
		...
		$this->DetailedEstimateApprovalStages=$this->fetchTable('DetailedEstimateApprovalStages');
		$this->Users=$this->fetchTable('Users');
		$this->BuildingItems=$this->fetchTable('BuildingItems');
	...
	public function contractorratedetails($pid = null, $work_id = null, $tender_id = null)
	{
		...
		$this->set(compact(
			...
			'tender_amount',
			'work_type',
			'contractor_detailcount',
			'contractoratedetails',
			'contractorcount',
			'project'
		));
	}
	...
	public function ajaxweatherapi($loc=null,$deg=null,$temp=null)
	{
		// echo 'hi';
		// exit();
		
		$this->set(compact('loc','deg','temp'));
	}
	...
	public function mbookstatusapproval($id = null, $work_id = null)
	{
		...
		$this->viewBuilder()->setLayout('layout');
		$this->MbookApprovalStatuses=$this->fetchTable('MbookApprovalStatuses');
		$this->MbookApprovalStages=$this->fetchTable('MbookApprovalStages');
		$this->ProjectWorkSubdetails=$this->fetchTable('ProjectWorkSubdetails');
		$this->Users=$this->fetchTable('Users');
		$this->Notifications=$this->fetchTable('Notifications');
		$user = $this->request->getAttribute('identity');
