								...
								<table id="answerTable" class="table  table-bordered  order-column" style="max-width: 99%;margin-left: 1%;">
									...
									<tr class="delete_docdetails_class_<?php echo $id ?> present_row">
									   ...
									   <td>
										...
										<td>
										 <?php echo $this->Form->control('project.'.$i.'.supervision_charge', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' =>'Supervision','min'=>1,'maxlength'=>13,'onkeyup'=>'calculateTotal('.$i.')','data-rule-required'=>true,'data-msg-required'=>'Enter Supervision Charge','value'=>($projectWorkSubdetail['supervision_charge'])?$projectWorkSubdetail['supervision_charge']:'0']) ?>
									   </td>   
										<td>
