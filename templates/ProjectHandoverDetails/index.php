...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Project Handover Details</header>
                <div class="tools">
                    <?php echo $this->Html->link(__('Add Handover Details<i class="fa fa-plus"></i>'), ['action' => 'projecthandoverdetails', $id], ['escape' => false, 'class' => ' btn btn-info']); ?>
                </div>
            </div>
            <div class="card-body ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
                                            ...
                                            <tbody>
                                                <?php $sno = 1;
                                                foreach ($projectHandoverDetails as $projectHandoverDetail) : ?>
                                                    <tr class="odd gradeX">
                                                        <td class="text-center"><?php echo $sno; ?></td>
                                                        <td class="title"><?php echo $projectHandoverDetail['handover_date'] ?></td>
                                                        <td class="title"><?php echo $projectHandoverDetail['remarks'] ?></td>
                                                        <td class="title">
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'projecthandoverdetailsedit', $id, $projectHandoverDetail['id']], ['escape' => false]); ?>
                                                            </div>
