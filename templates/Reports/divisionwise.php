		   ...
		   <div class="card-box">           
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-body">	
						<center><h4><b>Division Wise Project Count <?php if($financial_year != ''){   ?>  for financial Year - <?php echo $financial_year;  } ?></b></h4></center>
								...
								<table class="table  table-bordered table-checkable order-column mobile-table">
									<thead>
										<tr class="text-center">
											...
											<th rowspan="2" style="width:8%;"> Division Name </th>
										...
										<?php $sno = 1;
										    foreach ($divisions_details as $key => $division) : ?>
											 ...
											 <tr class="odd gradeX">
                                                        ...
                                                        <td>
                                                            <?php $totolproject_con   = $division['total_count_con']; ?>
                                                            <?php if ($totolproject_con > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,3,1,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totolproject_con; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
														 <td>
                                                            <?php $totolproject_rep   = $division['total_count_rep']; ?>
                                                            <?php if ($totolproject_rep > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,3,2,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totolproject_rep; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php $totalprogress_con  =  $division['inprogress_con']; ?>
                                                            <?php if ($totalprogress_con > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,5,1,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totalprogress_con; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
														<td>
                                                            <?php $totalprogress_rep  =  $division['inprogress_rep']; ?>
                                                            <?php if ($totalprogress_rep > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,5,2,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totalprogress_rep; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php $totalcompleted_con = $division['completed_con']; ?>
                                                            <?php if ($totalcompleted_con > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,6,1,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totalcompleted_con; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
														<td>
                                                            <?php $totalcompleted_rep = $division['completed_rep']; ?>
                                                            <?php if ($totalcompleted_rep > 0) { ?>
                                                                <a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getempdesgn(<?php echo  $key; ?>,6,2,<?php echo ($financial_year_id)?$financial_year_id:0; ?>)"><?php echo $totalcompleted_rep; ?></a>
                                                            <?php } else {
                                                                echo "0";
                                                            } ?>
                                                        </td>
...
<div id="report" style="display:none;">
    <div class="table-responsive" id="div_vc">
      <table class="table table-striped tbl-simple table-bordered dataTable display" aria-describedby="DataTables_Table_0_info" border="1" style="border-collapse: collapse;">
		...
		<tr>
			<td style='text-align:center' colspan="11"><b>Division Wise Project Count <?php if($financial_year != ''){   ?>  for financial Year - <?php echo $financial_year;  } ?>
				</b></td>
		</tr>
		<tr class="text-center">
			<th rowspan="2" style="width:2%;"> Sno </th>
		...
		<?php $sno = 1;
			foreach ($divisions_details as $key => $division) : ?>			
			 <tr class="odd gradeX">
				...
				<td><?php echo   $division['division_name']; ?></td>
				<td>
					<?php $totolproject_con1   = $division['total_count_con']; ?>
				 ...
				 <td>
					<?php $totolproject_rep1   = $division['total_count_rep']; ?>
				...
				<td>
					<?php $totalprogress_con1  =  $division['inprogress_con']; ?>
				...
				<td>
					<?php $totalprogress_rep1  =  $division['inprogress_rep']; ?>
				...
				<td>
					<?php $totalcompleted_con1 = $division['completed_con']; ?>
				...
				<td>
					<?php $totalcompleted_rep1 = $division['completed_rep']; ?>
...
<script>
function getempdesgn(id, type,work_type,fin_year) {
    // alert(id);
    // alert(type);
