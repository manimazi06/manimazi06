	...
	/*public function projectmonitoring($id = null, $work_id = null)
    {
      ...
      if(isset($monitoring)){
	   ...
	   if ($monitoringDetailscount == 0) {
        ...
        //$this->set(compact('projectMonitoringDetail', 'projectWork', 'monitorings', 'workStages', 'monitoring', 'monitoringDetailscount', 'administrativesanctioncount', 'administrativesanction', 'financialSanctionscount', 'financialSanctions', 'percentage', 'id','photo_uploads'));
              $this->set(compact('projectMonitoringDetail','workStages','projectTenderDetail', 'projectWork', 'tenders', 'id','administrativesanctioncount','administrativesanction','projectWorkSubdetail','financialSanctionscount','financialSanctions','work_id','contractor_detail_count','contractor_details','technicalcount','technical', 'monitoring', 'monitoringDetailscount','photo_uploads','monitorings'));
