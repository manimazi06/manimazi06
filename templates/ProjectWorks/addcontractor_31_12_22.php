                                 ...
                                 <div class="col-md-12">
                                     <?php if ($contractor_detail_count == 0) { ?>
                                         <div class="form-group row">
                                             ...
                                             <div class="col-md-3">
                                                 <?php echo $this->Form->control('contractor_id', ['empty' => 'Select Contractor/Company', 'class' => 'form-select select2', 'options' => $contractor_type, 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'required']); ?>
