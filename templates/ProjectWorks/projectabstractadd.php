        ...
        <div class="card-box">
                                ...
                                <div class="card-body">                              
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
											...
											<tfoot >  
												<tr>
												   <td colspan="6" style="text-align:right"><b>SUB TOTAL I (in Rs.)</b>&nbsp;&nbsp;</td>
												   <td style="text-align:right"><?php echo ($tot_amount)?$tot_amount:'0.00'; ?>&nbsp;
										...
										<table class="table  table-bordered table-checkable order-column" style="width: 100%" >
										  <tr>
										     ...
										     <td style="width:20%;">
											     <?php echo $this->Form->control('gst_at_18', ['class' => 'form-control amount ', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Amount','id'=>'gst_18','onkeyup'=>'addsubtotal_2()','value'=>($abstract_detail['gst_at_18'])?$abstract_detail['gst_at_18']:(($technical['gst'])?$technical['gst']:0)]); ?>
											 </td>
										  </tr>
										  <tr>
		    ...
		    <div class="form-group" style="padding-top: 10px;">
				<div class="offset-md-5 col-md-10">
					...
					<?php }*/ ?>
					<button type="submit" class="btn btn-success" onclick="setvalue()" id ="finalvalue"></button>
...
function addgrandtotal(){	
	...
	var grand_total =  parseFloat(total)+parseFloat(advertisement);	
	 ...
	 if(parseFloat(grand_total) <= 600000){
	 $('#finalvalue').html('Forward to EE / Final Submit');
	 }else if((parseFloat(grand_total) >= 600000) && (parseFloat(grand_total) <= 3000000)){
	 $('#finalvalue').html('Forward to SE / Final Submit');
	 }else if(parseFloat(grand_total) >= 3000000){
	 $('#finalvalue').html('Forward to CE / Final Submit');
	 }
}
