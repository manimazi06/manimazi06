                ...
                <div class="form-body row">
                    <div class="col-md-12">
					     <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('ref_no', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'placeholder' => 'Enter Ref No','type'=>'textarea','rows'=>3]); ?>
                            </div>                          
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-2">Work Name <span class="required"> * </span></label>
                            <div class="col-md-4">
                                <?php echo $this->Form->control('work_name', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Work Name',  'required','value'=>$projectsubdetail['work_name']]); ?>
                            </div>
                            <label class="control-label col-md-2">Place/Area Name<span class="required"> * </span></label>
                            <div class="col-md-4">
                                <?php echo $this->Form->control('place_of_work', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'type' => 'text','error' => false, 'placeholder' => 'Enter Place Area', 'required','value'=>$projectsubdetail['place_name']]); ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('district_id', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $districts, 'label' => false, 'error' => false, 'empty' => 'Select Districts', 'onchange' => 'loadcircle(this.value)', 'required','value'=>$projectsubdetail['district_id']]); ?>
                            </div>
                            <label class="control-label col-md-2">Divisions <span class="required"> * </span></label>
                            <div class="col-md-4">
                                <?php echo $this->Form->control('division_id', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $divisions, 'label' => false, 'error' => false, 'id' => 'project-division-id', 'empty' => 'Select Division', 'required', 'disabled','value'=>$projectsubdetail['division_id']]); ?>
                                <?php echo $this->Form->control('project_division_id1', ['type' => 'hidden', 'label' => false, 'error' => true, 'value'=>$projectsubdetail['division_id']]) ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('circle_id', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'], 'options' => $circles, 'label' => false, 'error' => false, 'empty' => 'Select Circle', 'id' => 'project-circle-id', 'required', 'disabled','value'=>$projectsubdetail['circle_id']]); ?>
                                <?php echo $this->Form->control('project_circle_id1', ['type' => 'hidden', 'label' => false, 'error' => true,'value'=>$projectsubdetail['circle_id']]) ?>

                            </div>
                            <label class="control-label col-md-2 ">Estimated Cost (in Rs.)<span class="required"> *
                                </span></label>
                            <div class="col-md-4">
                                <?php echo $this->Form->control('estimated_cost', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'type' => 'text', 'min'=>1,'maxlength'=>13,'required','value'=>$projectsubdetail['rough_cost']]); ?>
                            </div>
                        </div>
                        <div class="form-group row">
