		...
		<?php if($administrativesanctioncount > 0){  ?>
			...
			<h4>GO Upload</h4>
			 <table style="width:100%;">
			   <tr>
			     <td>
			       <iframe src="<?php echo $this->Url->build('/uploads/AdministrativeSanctions/'.$administrativesanction[0]['go_file_upload'],['fullBase' => true]); ?>#toolbar=0" height="1200" width="930"  style="overflow: hidden;"></iframe>  
