...
<!--
    <section class="dashboard">
        ...
        <dl style="background-color:#DC143C ;">
            ...
            <dd>                <span href="javascript:;" class="single-mail">
                            ...
                            <div class="card crm-widget">
                                <div class="card-body p-0">
                                    <div class="row row-cols-xxl-3 row-cols-md-3 row-cols-1 g-0">
                                        <div class="col">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Total project</h5>
                                       ...
                                       <div class="col">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Project In Progress</h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0 mt-0">
                                                            <span class="counter-value">
                                        ...
                                        <div class="col">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Project Completed</h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 ms-3">
                                                        <h2 class="mb-0 mt-0">
                                                            <span class="counter-value">
