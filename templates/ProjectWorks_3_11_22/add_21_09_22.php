                ...
                <div class="form-body row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo $this->Form->control('latitude', ['class' => 'form-control amount1', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => true, 'type' => 'text','maxlenth'=>10,'minlenth'=>10]); ?>
                            </div-->                           
                        </div>                      
