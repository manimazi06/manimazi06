                                        ...
                                        <tbody>
                                            ...
                                            foreach ($contractors as $contractor) : ?>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="text-center"><?php echo $contractor['reg_no'] ?></td>
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'edit', $contractor['id']], ['escape' => false]); ?>
                                                        </div>

                                                        <div class="btn btn-light" title="renewal">
                                                            <?php echo $this->Html->link('Renewal', ['action' => 'licenserenewal', $contractor['id']], ['escape' => false]); ?>
                                                    </td>
