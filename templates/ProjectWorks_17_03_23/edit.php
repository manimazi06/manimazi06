                                    ...
                                    <table id="answerTable" class="table  table-bordered  order-column" style="max-width: 99%;margin-left:1%;">
                                        <thead>
                                            <tr align="center">
                                                ...
                                                <th style="width:12%">Place Name</th>
                                        ...
                                        <tbody class="add_doc">
										 <?php
                                            ...
                                            <tr class="present_row row_<?php echo $key;  ?>">
											    ...
											    <td>
													<?php echo $this->Form->control('project.'.$key.'.place_name', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => true, 'type' => 'text','data-rule-required'=>true,'data-msg-required'=>'Enter Place Name','value'=>$projectWorkSubdetail['place_name']]) ?>
												</td>
												<td>
