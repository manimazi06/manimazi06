								  ...
								  <?php  $i = 0;  foreach ($projectFundRequestdetails as $projectFundRequestdetail): ?>	
									 <tr align="center">
									   <td class="trcount"><?php echo $i+1; ?></td>
										...
										<td>
										   <?php echo $this->Form->control('project.'.$i.'.final_balance', ['class' => 'form-control amount bal_amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' =>'Balance Amount','min'=>1,'maxlength'=>13,'readonly']) ?>
										</td>
