...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Contractor Report</header>
            </div>
            <div class="card-body">                
				<div class="row">
					<div class="col-md-12">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<div class="card-body">			
								<center>
									 <h4><strong>Contractor Report&nbsp;&nbsp;as on <?php echo date('M Y');  ?></strong></h4>
								</center>
								 ...
								 <div class="table-scrollable">
								   <table class="table  table-bordered table-checkable order-column" style="width:80%">
									 ...
									 <tbody>
										...
										<?php if ($project['cont_name'] != '') { ?>
											<tr class="odd gradeX">
												<td class="text-center"><?php echo $sno; ?></td>
												<td class="text-center"><?php //echo $project['cont_name']; ?>
												<?php if ($project['cont_name'] != '') { ?>
													<a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdetails(<?php echo  $project['cont_id']; ?>,1);"><?php echo $project['cont_name']; ?></a>
												<?php }  ?>										
												</td>
												<td  style="text-align:right;"><?php //echo $project['cont_name']; ?>
												<?php if ($project['tot_agreement_amount'] != '') { ?>
													<a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdetails(<?php echo  $project['cont_id']; ?>,2);"><?php echo ($project['tot_agreement_amount'])?ltrim($fmt->formatCurrency((float)$project['tot_agreement_amount'],'INR'),'₹'):'0.00' ;; ?></a>
												<?php }  ?>										
												</td>
													<td  style="text-align:right;"><?php //echo $project['cont_name']; ?>
												<?php if ($project['tot_expenditure_incurred'] != '') { ?>
													<a href="javascript:void(0);" style="text-decoration:underline;color:blue;padding:0px;" onclick="getdetails(<?php echo  $project['cont_id']; ?>,3);"><?php echo ($project['tot_expenditure_incurred'])?ltrim($fmt->formatCurrency((float)$project['tot_expenditure_incurred'],'INR'),'₹'):'0.00' ;; ?></a>
												<?php }  ?>										
												</td>
											</tr>
									 	<?php
										   } 
											$tot_agreement_amount  += $project['tot_agreement_amount'];
											$expenditure_incurred  += $project['tot_expenditure_incurred'];  
											$sno++;
										    endforeach;
									...
									<tfoot>
										<tr>
											...
											<th style="text-align:right;"><?php echo ($tot_agreement_amount)?ltrim($fmt->formatCurrency((float)$tot_agreement_amount,'INR'),'₹'):'0.00' ; ?>&nbsp;</th>
...
<script>
	...
	function getdetails(id, type) {	   
		...
		$.ajax({
			...
			dataType: "html",
			type: "post",
			url: '<?php echo $this->Url->webroot ?>/tnphc/Reports/ajaxcontractorreport/'+id+'/'+ type+'/'+division_id,  
