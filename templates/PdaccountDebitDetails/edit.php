<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Edit PD Account Debit Details</header>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-body row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('remarks', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Remarks', 'required']); ?>
                                </div>
                            </div>
                        </div>
