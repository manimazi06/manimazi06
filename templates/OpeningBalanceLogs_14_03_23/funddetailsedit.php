                           ...
                           <div class="form-body row">  
                              <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <?php echo $this->Form->control('request_amount', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'value' => $openingBalanceLog['request_amount'], 'required']); ?>
                                    </div>
                                </div>
                                <div class="form-group row ">
