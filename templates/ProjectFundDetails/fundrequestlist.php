...
<div class="col-md-12"><?php //echo 'hi'; exit(); ?>
    <div class="card card-topline-aqua">
        <div class="card-head">
            <header>Project Fund List</header>  
          </div>
		  <div class="card-body"> 
		    <div class="col-md-12">
									...
									<tr>
										...
										<td class="text-center" style="margin-top:10px;">
											<span style="margin-top:10px;">
												<?php echo $this->Html->link(__('<i class="fa fa-eye"></i> View'), ['controller'=>'ProjectWorks','action' => 'view',$projectWork['id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm','target'=>'_blank']); ?>
