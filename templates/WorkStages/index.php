...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>work Stages</header>
				<div class="tools">
                                            <?php echo $this->Html->link(__('Add workStages<i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class' => ' btn btn-info']); ?>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <!--  <div class="row">
                                        ...
                                        <?php //if ($workStages != '') {  ?>
                                            <?php //if (isset($workStages)) { ?>
                                                <?php //if (count($workStages) > 0) { ?>
                                    ...
                                    <div class="table-scrollable user-table">
                                        <table class="table  table-bordered table-checkable order-column mobile-table" id="example4">
                                            ...
                                            <tbody>
                                                <?php $sno = 1;
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="title"><?php echo $workStage['name'] ?></td>
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'edit', base64_encode($workStage['id'])], ['escape' => false]); ?>
                                                            </div>
                                           ...
                                           </svg><!--end::Svg Icon--></span>'), ['action' => 'delete', base64_encode($workStage['id'])], ['confirm' => __('Are you sure you want to delete {0}?',  $workStage['name']), 'escape' => false]);*/ ?>
                                                            </div-->
                                                            </span>
                                                        </td>
