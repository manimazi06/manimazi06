...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Building Materials Types</header>				
				<div class="tools">
					  <?php echo $this->Html->link(__('Add Building Material Type<i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class' => ' btn btn-info']); ?>
				</div>
            </div>
            <div class="card-body ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
                                            ...
                                            <tbody>
                                                <?php $sno = 1;
                                                    foreach ($buildingMaterials as $buildingMaterial) : ?>
                                                    <tr class="odd gradeX">
