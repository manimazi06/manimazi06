                            ...
                            <div class="col-md-12" style="margin-top:">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php if ($projectwiseDevelopmentWork['detailed_estimate_upload'] != '') {  ?>
                                            <?php echo $this->Form->control('detailed_estimate_upload1', ['type' => 'hidden', 'value' => $projectwiseDevelopmentWork['detailed_estimate_upload']]); ?>
                                              <a style="color:blue;" href="<?php echo $this->Url->build('/uploads/DetailedEstimates/'.$projectwiseDevelopmentWork['detailed_estimate_upload'], ['fullBase' => true]); ?>" target="_blank"><span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <?php echo $this->Form->control('detailed_estimate_amount', ['class' => 'form-control amount', 'type' => 'file', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'required', 'type' => 'text', 'min' => 1, 'maxlength' => 15, 'value' => ($projectwiseDevelopmentWork['detailed_estimate_amount'])?$projectwiseDevelopmentWork['detailed_estimate_amount']:'']); ?>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
