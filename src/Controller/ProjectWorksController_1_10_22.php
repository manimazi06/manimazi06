    ...
    //$projectWorkSubdetails        = $this->ProjectWorkSubdetails->find('all')->contain(['Districts','Divisions','Circles'])->where(['ProjectWorkSubdetails.project_work_id' => $id])->toArray();
     //$projectWorkSubdetailscount  = $this->ProjectWorkSubdetails->find('all')->where(['ProjectWorkSubdetails.project_work_id' => $id])->count();
		if($role_id = 2 || $role_id = 3 || $role_id = 4){
  		   $projectWorkSubdetails       = $this->ProjectWorkSubdetails->find('all')->contain(['Districts','Divisions','Circles'])->where(['ProjectWorkSubdetails.project_work_id' => $id,'ProjectWorkSubdetails.division_id'=>$division_id])->toArray();
  		}else{
		   $projectWorkSubdetails       = $this->ProjectWorkSubdetails->find('all')->contain(['Districts','Divisions','Circles'])->where(['ProjectWorkSubdetails.project_work_id' => $id])->toArray();
		}
   ...
   public function funddetails($id = null, $work_id = null)
   {
	...
	public function ajaxgetworkdetails($id = null)
    {
		...
		if($role_id == 2 || $role_id == 3 || $role_id == 4 ||  $role_id == 13 || $role_id == 14){
  		   ...
  		   $projectWorkSubdetails       = $this->ProjectWorkSubdetails->find('all')->contain(['Districts','Divisions','Circles'])->where(['ProjectWorkSubdetails.project_work_id' => $id,'ProjectWorkSubdetails.circle_id'=>$circle_id])->toArray();
