                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group pull-right">
                                                <button
                                                    class="mdl-button mdl-js-button mdl-js-ripple-effect m-b-10 deepPink-bgcolor btn btn-outline dropdown-toggle btn-sm"
                                        ...
                                        <table class="table  table-bordered table-checkable order-column"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <!-- <td><?php echo $user['Districts']['name']; ?></td> -->
                                                    <td class="title"><?php echo $user['name'] ?></td>
                                                    <td><?php echo $user['username']; ?></td>
                                                    <td><?php echo $user['email']; ?></td>
                                                    <td class="text-right"><?php echo $user['mobile_no']; ?>
                                                    </td>
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'edit',base64_encode($user['id'])], ['escape' => false]); ?>
                                                        </div>                                                  
                                                        </span>
                                                    </td>
                                                </tr>
