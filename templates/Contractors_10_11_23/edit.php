                    ...
                    <div class="form-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <?php echo $this->Form->control('reg_no', ['class' => 'form-control', 'maxlength' => 15, 'templates' => ['inputContainer' => '{{content}}'],  'label' => false, 'placeholder' => 'Registration number', 'error' => false, 'required', 'readonly']); ?>
                                </div>
