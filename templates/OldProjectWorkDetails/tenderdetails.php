                    ...
                    <div class="form-body row addpagess">
                        <div class="col-md-12 tender">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <?php echo $this->Form->control('tender_amount', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'type' => 'text', 'required', 'value' =>($total_amount)?$total_amount:$projectTenderDetail['tender_amount'],'readonly']); ?>
                                </div>
                            </div>
                        </div>
                    </div>
