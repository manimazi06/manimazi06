             ...
             <!--div class="form-body row"-->
								...
								<tbody>
									<?php $sno = 1;
										...
										<tr class="odd gradeX">
											...
											<td class="title" style="text-align:center;"><?php echo ($abstract_subdetail['new_item_code'] != 0)?$abstract_subdetail['new_item_code']:'' ?></td>
											...
											<td>
											 ...
											 <?php //echo $this->Form->control('tender_id', ['label' => false, 'error' => false,'type'=>'hidden', 'readonly','value'=>1]); ?>
                 ...
                 <div class="form-group" style="padding-top: 5px;">
                     <div class="offset-md-5 col-md-10">
					 	 ...
					 	 <?php echo $this->Form->create($projectTenderDetails, ['id' => 'FormID1', 'class' => 'form-horizontal', "autocomplete" => "off", "onsubmit"=>"return finalsubmit()", 'enctype' => 'multipart/form-data','action'=>'../../../contractorfinalsubmit']); ?>
                         ...
                         <?php  if($projectWorkSubdetail['contractor_final_submit'] == 0){  ?>
                         <button type="submit" class="btn btn-info m-r-20" >Final Submit</button>
