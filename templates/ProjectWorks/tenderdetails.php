                                ...
                                <td class="text-center">
                                    <span style="overflow: visible; position: relative; width: 177px;">
									   ...
									   <?php } ?>
										...
										<?php  if($contractor_detailscount[$projectTenderDetail['id']] > 0){ ?>
									    <?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Add Contractor Rate'), ['action' => 'contractorratedetails', $id, $work_id, $projectTenderDetail['id']], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm']); ?><br><br>
										<?php } ?>
...
<?php  }*/ ?>
<?php if($contractor_detail_count >0 && $tender_count >0 && $projectWorkSubdetail['tender_detail_flag'] == 0 && $projectWorkSubdetail['contractor_final_submit'] == 1) {  ?>
        <div class="form-group" style="padding-top: 10px;">
            <div class="offset-md-5 col-md-10">
