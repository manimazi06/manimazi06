<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Add buildingType</header>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-body row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('name', ['class' => 'form-control name titleCase', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'buildingType Name', 'required']); ?>
                                </div>
                            </div>
                        </div>
