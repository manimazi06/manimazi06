...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Add Project Abstract Details	
                                ...
                                <table class="table  table-bordered  order-column" style="max-width:100%;margin-right:1%;">
                                    ...
                                    <tbody class="adding">
                                        <tr class="present_row_in_post">
                                            ...
                                            <td><?php echo $this->Form->control('workdetail.0.rate', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter rate','id'=>'r_0','onkeyup'=>"product(0)",'data-rule-required'=>false,'data-msg-required'=>'Enter Rate']); ?>
                                            </td>                                            
                                            <td>
											<?php echo $this->Form->control('workdetail.0.amount', ['class' => 'form-control divided_amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Amount','id'=>'cal_total_0', 'readonly']); ?>
                                            </td>
                                            <td>
									...
									<tfoot>
										<tr>
										   ...
										   <td><?php echo $this->Form->control('total_amount', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false,'readonly']) ?></td>
										   <td></td>
										</tr>
									</tfoot>
                                </table>
        ...
        <div class="card-box">
            ...
            <div class="card-body ">
                                ...
                                <div class="card-body">                              
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
											...
											<tfoot>
												<tr>
												   <td colspan="5" style="text-align:right"><b>Total (in Rs.)</b>&nbsp;&nbsp;</td>
				...
				<div class="form-group row">
				  <label class="control-label col-md-4 bol">Detailed Estimate Upload. <span class="required">* (xls,xlsx Format only) <br>(Maximum 8MB Only) </span></label>
					<div class="col-md-5">
		...
		<tbody>
			<?php $sno = 1;
				...
				<tr class="odd gradeX">
					...
					<td class="title"><?php echo $abstract_subdetail['amount'] ?></td>					
				</tr>
			<?php $sno++;
				endforeach; ?>
		</tbody>
    ...
    if (code != '') {
        if (document != '' || document1 != '') {
            $.ajax({
                async: true,
                dataType: "html",
                url: '<?php echo $this->Url->webroot ?>/tnphc/ProjectWorks/ajaxprojectdevelopmentwork/' +
                    j+'/'+type,
