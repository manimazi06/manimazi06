									...
									<tr>
										...
										<td class="text-center">
											<span style="margin-top:15px;">
												<?php echo $this->Html->link(__('<i class="fa fa-eye"></i> View'), ['controller'=>'ProjectWorks','action' => 'view',$projectWork['id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
											    <?php if($role_id == 9 && $projectWork['ce_approved'] == 0){  ?>
												<?php //echo $this->Html->link(__('<i class="fa fa-pencil"></i> Edit'), ['action' => 'edit',$projectWork['id']], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												 <?php } ?>
