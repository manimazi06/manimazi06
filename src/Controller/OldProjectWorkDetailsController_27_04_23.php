...
class OldProjectWorkDetailsController extends AppController  
{
  ...
  public function technicalsanction($id = null,  $pid = null, $work_id = null)  
  {
   ...
   // $this->loadModel('Notifications');
	...
	$this->set(compact('projectwork','technical','work_type','subabstractcount','tot_amount','units','projectDevelopmentWorkDetail', 'projectWorks','buildingItems','projectWorkSubdetails', 'developmentWorks','id','pid','work_id','abstract_subdetails','detailed_approval_stages_count','detailed_approval_stages','abstractcount','projectWorkSubdetail'));
