<div class="row">
    <div class="col-md-12">     
		<div class="card">
		    <div class="card-head">
				 <header>Notifications (Pending Works)</header>				
			</div>
			 <div class="card-body ">   
			  <div class="row">
				<div class="table-scrollable">
					<table class="table table-hover table-bordered" style="width: 100%">
						...
						<tbody>			
							<?php $sno = 1;	foreach ($notification_list as $notification) : ?>
								<tr>
									<td ><?php echo ($sno); ?></td>
									<td ><?php echo $notification['project_work']['project_name']; ?></td>
									...
									<td class="text-center">
										<span style="margin-top:15px;">				   
											...
											<?php }else if($notification['notification_type_id'] == 17){  ?>
											<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'ProjectWorks','action' => 'mbookstatusapproval',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
											<?php }else if($notification['notification_type_id'] == 18){  ?>
											<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'MbookDetails','action' => 'mbookdetailsapproval',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
											<?php }else if($notification['notification_type_id'] == 19){  ?>
											<?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-right"></i> Go to Page'), ['controller'=>'MbookDetails','action' => 'excessquantityapproval',$notification['project_work_id'],$notification['project_work_subdetail_id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?>&nbsp;&nbsp;&nbsp;
											<?php } ?>
										</span>
									</td>                                               
								</tr>
