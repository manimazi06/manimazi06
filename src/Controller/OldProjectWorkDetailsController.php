...
class OldProjectWorkDetailsController extends AppController  
{
   ...
   //        echo"<pre>";print_r($id,$pid,$work_id);exit();
        ...
        $division_id = $user->division_id;
        $this->ProjectWorkSubdetails=$this->fetchTable('ProjectWorkSubdetails');
        $this->ProjectWorks=fetchTable('ProjectWorks');
        $this->DepartmentwiseWorkTypes=fetchTable('DepartmentwiseWorkTypes');
        $this->Districts=fetchTable('Districts');
        $this->Divisions=fetchTable('Divisions');
	    $this->Circles=fetchTable('Circles');
		$this->Departments=fetchTable('Departments');
        $this->FinancialYears=fetchTable('FinancialYears');       
        $this->SchemeTypes=fetchTable('SchemeTypes');
   ...
   public function completedbasicdetail($id = null, $pid = null, $work_id = null)
    ...
    public function projectdetailedestimate($id = null, $pid = null, $work_id = null)
    {
        ...
        $this->OldProjectWorkDetails=$this->fetchTable('OldProjectWorkDetails');
   ...
   // $this->=$this->fetchTable('Notifications');
    $this->OldProjectWorkDetails=$this->fetchTable('OldProjectWorkDetails');
