...
<tr class="delete_docdetails_class_<?php echo $i ?> present_row">
   ...
   <td>
    <?php echo $this->Form->control('project.' . $i . '.work_name', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'type' => 'textarea', 'label' => false, 'error' => true,'rows'=>'3','data-rule-required'=>true,'data-msg-required'=>'Enter Work Name']) ?></td>
