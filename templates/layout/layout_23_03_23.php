						  ...
						  <?php  }  ?>
							...
							<?php if($LOGGED_ROLE == 14 || $LOGGED_ROLE == 4 || $LOGGED_ROLE == 5 || $LOGGED_ROLE == 6){  ?>
							  ...
							  <?php /*if($LOGGED_ROLE == 13 || $LOGGED_ROLE == 4 || $LOGGED_ROLE == 5 || $LOGGED_ROLE == 6 || $LOGGED_ROLE == 8){  ?>
							   <li>
                                  <?php echo $this->Html->link('<i class="fa fa-money"></i><span class="title">&nbsp;Fund Request</span>', array('controller' => 'ProjectWorks', 'action' => 'projectlist',6), array('escape' => false, 'class' => 'nav-link')); ?>
                              </li>							   
							  <?php  }*/ ?>
							  ...
							  <?php  } ?>
							  <?php if($LOGGED_ROLE == 13 || $LOGGED_ROLE == 5 || $LOGGED_ROLE == 6 || $LOGGED_ROLE == 17){    ?>
							    <li>
							  ...
							  <?php  } ?>
							    <?php if($LOGGED_ROLE == 6 || $LOGGED_ROLE == 8 || $LOGGED_ROLE == 1){    ?>
							 <li
