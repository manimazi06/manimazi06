						...
						<table class="table table-hover table-bordered table-advanced tablesorter display" style="width: 100%" id="example4">
							<thead>
								<tr class="text-center">
									...
									<th style="width:10%;">Estimate Cost (Rs.) </th>
									...
									<tr>
										...
										<td class="text-center">
											<span style="margin-top:15px;">
												<?php echo $this->Html->link(__('<i class="fa fa-eye"></i> View'), ['controller'=>'ProjectWorks','action' => 'view',$projectWork['id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?><br><br>
												...
												<?php echo $this->Html->link(__('<i class="fa fa-trash"></i>Delete'), ['action' => 'deleterepairwork',$projectWork['id']], ['confirm' => __('Are you sure you want to delete Project - {0}?',  $projectWork['project_name']), 'class' => 'btn btn-outline-danger btn-sm', 'escape' => false]); ?><br><br>
 											    <?php } ?>
												<?php if($role_id == 6 && $projectWork['ce_approved'] == 0){  ?>
												 	<?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Approve'), ['controller'=>'ProjectWorks','action' => 'projectapprove',$projectWork['id']], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm']); ?>&nbsp;&nbsp;&nbsp;
											    <?php } ?>
