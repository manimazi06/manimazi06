<tr class="row_remove_tr<?php echo $i ?> present_row_in_post">
    ...
    <td><?php echo $this->Form->control('workdetail.'.$i.'.quantity', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Quantity', 'id' => 'q_'.$i.'', 'onkeyup' => "product(".$i.")",'data-rule-required'=>false,'data-msg-required'=>'Enter Rate']); ?>
	 ...
	 <td>
		<?php echo $this->Form->control('workdetail.'.$i.'.unit_id', ['class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Select Unit','data-rule-required'=>false,'data-msg-required'=>'Select Unit','options'=>$units,'empty'=>'-Select-']); ?>
    </td>
    ...
    <td>
        <?php echo $this->Form->control('workdetail.'.$i.'.amount', ['class' => 'form-control divided_amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Amount','id'=>'cal_total_'.$i.'', 'readonly','value'=>0]); ?>
        <?php //echo $this->Form->control('workdetail.'.$i.'.amount_test', ['class' => 'form-control divided_amounts','type'=>'text','value'=>0]); ?>
	</td>
