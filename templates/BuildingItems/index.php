...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Building Items</header>
				<div class="tools">
				    <?php if($LOGGED_ROLE == 1){ ?>
					  <?php echo $this->Html->link(__('Add Building Items<i class="fa fa-plus"></i>'), ['action' => 'add'], ['escape' => false, 'class' => ' btn btn-info']); ?>
					<?php  } ?>
				</div>
            </div>
            <div class="card-body ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'edit', $buildingItem['id']], ['escape' => false]); ?>
                                                            </div>                                                        
                                                        </td>
														<?php  } ?>
                                                    </tr>
