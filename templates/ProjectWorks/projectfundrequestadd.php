                ...
                <div class="form-body row">                	
                        <?php  // if (isset($projectworkdetails)) {   ?>
							...
							<fieldset  style="border:1px solid #00355F;border-radius:10px; margin-top:0%;padding:15px;margin-left:5px;margin-bottom:0%">
							 <div class="form-group">                               
								<table id="example4" class="table  table-bordered  order-column" style="max-width: 100%;margin-left: 0%;">
									<thead>
										<tr align="center">
										   <th style="width:1%"><!--input type="checkbox" class ="select_all" id='allcb'> Select All</input--></th>
											<th style="width:1%"> S.No</th>
											<th style="width:5%">Work ID</th>
									   ...
									   <?php
										...
										foreach ($projectworkdetails as $projectWorkSubdetail) : ?>										
										 <tr> 
										   ...
										   <td align="right"><?php echo $projectWorkSubdetail['fs_amount']; ?></td>										
										   <td align="right"><?php echo $projectWorkSubdetail['fs_excluding_sc']; ?></td>								
										</tr>
										  <?php
											// $tot_fs_amount         += $projectWorkSubdetail['fs_amount'];
											// $tot_fs_excluding_sc    += $projectWorkSubdetail['fs_excluding_sc'];
										     $i++;
										     endforeach; ?>
									</tbody>
									<!--tfoot>
						...
						<?php  //}  ?> 
						  <div id="confirm_as" style="display:none;">  
							...
							<fieldset  style="border:1px solid #00355F;border-radius:10px; margin-top:0%;padding:10px;margin-left:0px;margin-bottom:1%">
							<div class="col-md-12">
								<div class="form-group row">
									...
									<div class="col-md-3">
										...
										<?php echo $this->Form->control('project_count', ['label' => false, 'error' => false, 'type' => 'hidden', 'required','value'=>0]); ?>
									</div>
								</div>								
                            </div><br>						 
							 <div class="form-group">                               
								<table id="answerTable" class="table  table-bordered  order-column" style="max-width:100%;margin-left:0%;">
									<thead>
										<tr align="center">
											<th style="width:1%"> S.No</th>
											<th style="width:5%">Work ID</th>
											...
											<th style="width:9%">Financial Sanction Excluding SC <br>(in Rs.)</th>
											<th style="width:13%">Expenditure Incurred So Far <br>(in Rs.)</th>
											<!--th style="width:10%">Balance Payment<br>(in Rs.)</th-->
											<th style="width:13%">Request Amount <br>(in Rs.)</th>   
											<th style="width:13%">Balance Amount <br>(in Rs.)</th>   
										</tr>
									</thead>
									<tbody class="add_doc">									   
									</tbody>
					 ...
					 <div class="form-group submit" style="padding-top: 10px;display:none;">
...
function loadproject(id){
	...
	//alert(isChecked);	
	if(isChecked === true){	
	 var j = $('#project-count').val();
	 // alert(j);
	 var i = parseInt(j) + 1;
	 $.ajax({
			async: true,
			dataType: "html",
			url: '<?php echo $this->Url->webroot ?>/ProjectWorks/ajaxfundrequestadd/'+id+'/'+i,
...
//alert(bal_amount);
  ...
  if(!isNaN(balance)){
	...
	$('#project-'+count+'-balance-amount').val(balance.toFixed(2));  
  }
}	
