            ...
            <div class="form-body row">
                <div class="col-md-12">
                    ...
                    <!--div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <?php echo $this->Form->control('latitude', ['class' => 'form-control num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => true, 'type' => 'text']); ?>
                        </div>
                        <label class="control-label col-md-2">longitude</label>
                        <div class="col-md-4">
                            <?php echo $this->Form->control('longitude', ['class' => 'form-control num', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => true, 'type' => 'text']); ?>
                        </div>
                    </div-->
                    <div class="form-group row">
