...
<head>
    ...
    <?php echo $this->Html->css('/css/viewer/viewer'); ?>
    <?php echo $this->Html->css('/css/viewer/main'); ?>
    ...
    <?php echo $this->Html->script('/js/viewer/viewer'); ?>
    <?php echo $this->Html->script('/js/viewer/main'); ?>
						 ...
						 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <?php  }   ?>										
							 <?php if($LOGGED_ROLE == 1 || $LOGGED_ROLE == 10){   ?>								
								<li>
									<?php echo $this->Html->link('<ion-icon name="home-outline"></ion-icon><span class="title">&nbsp;Items Codes / Description</span>', array('controller' => 'NewBuildingItems', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
                               </li>
							   <li <?php if($this->request->getParam('controller') == 'Contractors'){?>class="nav-item active"
									<?php }?>>
									<?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Contractors</span>', array('controller' => 'Contractors', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
							...
							<?php  } ?>  
							 ...
							 <?php if($LOGGED_ROLE == 18){   ?>
							  ...
							  <?php } ?>
							  <?php if($LOGGED_ROLE == 6 || $LOGGED_ROLE == 8 || $LOGGED_ROLE == 1 || $LOGGED_ROLE == 2 || $LOGGED_ROLE == 3 || $LOGGED_ROLE == 4 || $LOGGED_ROLE == 13 || $LOGGED_ROLE == 14  || $LOGGED_ROLE == 17){    ?>
							 <li
									...
									<ul class="sub-menu">
										...
										<li <?php if ($this->request->getParam('controller') == 'Reports') { ?>class="nav-item active" <?php } ?>>
										 ...
										 <li <?php if ($this->request->getParam('controller') == 'Reports') { ?>class="nav-item active" <?php } ?>>
                                            <?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;AS/ FS Report</span>', array('controller' => 'Reports', 'action' => 'projectasfsreport'), array('escape' => false, 'class' => 'nav-link')); ?>
									     </li> 
										 <li <?php if ($this->request->getParam('controller') == 'Reports') { ?>class="nav-item active" <?php } ?>>
                                            <?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Timeline Report</span>', array('controller' => 'Reports', 'action' => 'timelinereport'), array('escape' => false, 'class' => 'nav-link')); ?>
									     </li> 
										<?php } ?>
										
										<?php if($LOGGED_ROLE == 16){  ?>
										<li <?php if ($this->request->getParam('controller') == 'Reports') { ?>class="nav-item active" <?php } ?>>
                                            <?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Direct Fund Report</span>', array('controller' => 'Reports', 'action' => 'directfundreport'), array('escape' => false, 'class' => 'nav-link')); ?>
									     </li> 
						  ...
						  <?php  }  ?>
							...
							<?php if($LOGGED_ROLE == 14 || $LOGGED_ROLE == 4 || $LOGGED_ROLE == 5 || $LOGGED_ROLE == 6){  ?>
							  ...
							  <li>
							   ...
							   <?php  } ?>
							    <?php if($LOGGED_ROLE == 15){    ?>
							  <li>
                                  <?php echo $this->Html->link('<i class="fa fa-money"></i><span class="title">&nbsp;Expenditure Details</span>', array('controller' => 'ProjectWorks', 'action' => 'projectlist',18), array('escape' => false, 'class' => 'nav-link')); ?>
                              </li>
							   <?php  } ?>
							   <?php if($LOGGED_ROLE == 9){    ?>
							    <li>
							  ...
							  <li>
							   ...
							   <li>
                                  <?php echo $this->Html->link('<i class="fa fa-money"></i><span class="title">&nbsp;Direct Funds</span>', array('controller' => 'DirectFundDetails', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
                              </li>
							  <li>
                                  <?php echo $this->Html->link('<i class="fa fa-money"></i><span class="title">&nbsp;PD Account Debit Details</span>', array('controller' => 'PdaccountDebitDetails', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
                              </li> 
                        ...
                        <ul class="sidemenu  page-header-fixed sidemenu-hover-submenu" data-keep-expanded="false"
                            ...
                            <?php  }   ?>										
							 <?php if($LOGGED_ROLE == 1 || $LOGGED_ROLE == 10){   ?>								
							    ...
							    <li
									<?php $masters = array('ContractorClasses','ContractorTypes','ContractorClassLevels','ContractorRegisteredDepartments');
									echo (in_array($this->request->getParam('controller'),$masters)) ? 'class="nav-item active"': ' ';?>>
									<a href="#" class="nav-link nav-toggle">
										<ion-icon name="apps-outline"></ion-icon>
										<span class="title">&nbsp;Contractor Masters</span> <span class="arrow"></span>
									</a>
									<ul class="sub-menu">
										<li <?php if($this->request->getParam('controller') == 'ContractorClasses'){?>class="nav-item active"
											<?php }?>>
											<?php echo $this->Html->link('<span class="title"><i class="icon-people"></i>&nbsp;Contractor Class</span>', array('controller' => 'ContractorClasses', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
										</li> 
										<li <?php if($this->request->getParam('controller') == 'ContractorClassLevels'){?>class="nav-item active"
											<?php }?>>
											<?php echo $this->Html->link('<span class="title"><i class="icon-calendar"></i>&nbsp;Contractor Class Levels</span>', array('controller' => 'ContractorClassLevels', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
										</li> 
										 <li <?php if($this->request->getParam('controller') == 'ContractorTypes'){?>class="nav-item active"
											<?php }?>>
											<?php echo $this->Html->link('<span class="title"><ion-icon name="golf-outline"></ion-icon>&nbsp;Contractor Types</span>', array('controller' => 'ContractorTypes', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
										</li> 
										 <li <?php if($this->request->getParam('controller') == 'ContractorRegisteredDepartments'){?>class="nav-item active"
											<?php }?>>
											<?php echo $this->Html->link('<span class="title"><ion-icon name="golf-outline"></ion-icon>&nbsp;Contractor Registered Department</span>', array('controller' => 'ContractorRegisteredDepartments', 'action' => 'index'), array('escape' => false, 'class' => 'nav-link')); ?>
										</li>
