...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Project Completion Details</header>
                <div class="tools">
                    <?php echo $this->Html->link(__('Add Completion Details<i class="fa fa-plus"></i>'), ['action' => 'projectwisecompletiondetails'], ['escape' => false, 'class' => ' btn btn-info']); ?>
                </div>
            </div>
            <div class="card-body ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
                                            ...
                                            <tbody>
                                                <?php $sno = 1;
                                                foreach ($projectwiseCompletionReports as $projectwiseCompletionReport) : ?>
                                                    <tr class="odd gradeX">
                                                        <td class="text-center"><?php echo $sno; ?></td>
                                                        <td class="title"><?php echo $projectwiseCompletionReport['completed_date'] ?></td>
                                                        <td class="title"><?php echo $projectwiseCompletionReport['remarks'] ?></td>
                                                        <td class="title">
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'projectwisecompletiondetailsedit', $id, $projectwiseCompletionReport['id']], ['escape' => false]); ?>
                                                            </div>
