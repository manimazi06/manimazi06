								...
								<tbody>
								   <?php $i = 0;
									 ...
									 <tr> 
										...
										<input name ='project[<?php echo $i; ?>][project_id]' type="checkbox" class ="checkboxFour"  id="project_<?php echo $i; ?>"  value="<?php echo $projectWorkSubdetail['project_work_id'];?>" onclick="loadproject(<?php echo $projectWorkSubdetail['project_work_id'];?>,<?php echo $i; ?>)">
										<input name ='project[<?php echo $i; ?>][fund_request_id]' type="hidden"  value="<?php echo $projectWorkSubdetail['fund_req_id'];?>">
									   </td>										 
...
function loadproject(id,count){
	...
	isChecked = $('#project_'+count).is(':checked');
