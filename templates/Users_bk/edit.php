                    ...
                    <div class="form-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('username1', ['class' => 'form-control name', 'type' => 'text', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Username', 'value' => $user->username, 'required']); ?>
                                </div>
                            </div>
