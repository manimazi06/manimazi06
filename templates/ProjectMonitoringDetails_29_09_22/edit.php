 ...
 * @var string[]|\Cake\Collection\CollectionInterface $workStages
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projectMonitoringDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projectMonitoringDetail->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="projectMonitoringDetails form content">
            ...
            <fieldset>
                <legend><?= __('Edit Project Monitoring Detail') ?></legend>
                <?php
