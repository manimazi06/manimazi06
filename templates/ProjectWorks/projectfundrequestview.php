							 ...
							 <table id="answerTable" class="table  table-bordered  order-column"
								 ...
								 <thead>
									 <tr align="center">
										...
										<th style="width:8%">Request Amount <br>(in Rs.)</th> 
									 ...
									 <tr align="center">
									   <td class="trcount"><?php echo $i+1; ?></td>
										<?php echo $this->Form->control('project.'.$i.'.id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => $projectFundRequestdetail['work_id']]); ?>
										 ...
										 <!--td align="right"><?php echo ($projectFundRequestdetail['balance_payment'])?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['balance_payment'],'INR'),'₹'):ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['fs_excluding_sc'],'INR'),'₹'); ?></td--> 
										 <td align="right"><?php echo ($projectFundRequestdetail['expenditure_incurred'])?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['expenditure_incurred'],'INR'),'₹'):'0.00'; ?></td>													 
										 ...
										 <!--td align="right"><?php echo ($projectFundRequestdetail['final_balance'] != '0.00')?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['final_balance'],'INR'),'₹'):'0.00'; ?></td-->													 
									     <?php } ?>
										 <td align="right"><?php echo ($projectFundRequestdetail['final_balance'] != '0.00')?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['final_balance'],'INR'),'₹'):ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['balance_amount'],'INR'),'₹'); ?></td> 
