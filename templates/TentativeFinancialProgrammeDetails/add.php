...
<div class="col-md-12">
    ...
    <div class="card card-topline-aqua">
        <div class="card-head">
            <header>Add Tentative Financial Programme Detail</header>
        </div>
        <div class="card-body">
                ...
                <div class="form-body row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label class="control-label col-md-3">Financial Year<span class="required"> * </span></label>
                            <div class="col-md-3">
                                <?php echo $this->Form->control('financial_year_id', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'options' => $financialYears, 'empty' => 'Select Financial Year','onchange'=>'yearchecking(this.value)','required']); ?>
                                <div class="financial-year-error" style="color:red;"></div>
                            </div>
                        </div>
                        <center>
                            <table class="table table-bordered order-column" style="width: 60%">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th width="15%">Tentative Amount (in lakhs) </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $sno = 1; { ?>
...
<script>
    ...
    function yearchecking(year){
        ...
        if(year){
            $.ajax({
                    type: 'POST',
                    url: '<?php echo $this->Url->webroot ?>/tnphc/TentativeFinancialProgrammeDetails/ajaxfinancial/'+year+'/'+division_id,
                    success: function(data, textStatus) {
                        //  alert(data);
                        if(data==1){
                            $('.financial-year-error').html('This Financial Year already Present');
                            $('.sub').prop('disabled',true);
                            // <span style='color:red'> Email already exists .</span>
                        }else{
                            $('.financial-year-error').html('');
