    ...
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                ...
                <div class="tools">
                    <?php echo $this->Html->link(__('Add Project Placed Board Details<i class="fa fa-plus"></i>'), ['action' => 'projectplacedtoboard'], ['escape' => false, 'class' => ' btn btn-info']); ?>
                </div>
            </div>
            <div class="card-body ">
                                        ...
                                        <table class="table  table-bordered table-checkable order-column"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="title">
                                                        <?php echo date('d-m-Y',strtotime($projectPlacedToBoardDetail['placed_date'])) ?>
                                                    </td>
                                                    <td class="title"> <a style="color:blue;"
                                                            href="<?php echo $this->Url->build('/uploads/projectplacedtoboard/' . $projectPlacedToBoardDetail['file_upload'], ['fullBase' => true]); ?>"
                                                            target="_blank"><span>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-icon tooltipster" title="Edit">
															...
															</svg><!--end::Svg Icon--></span>'), ['action' => 'projectplacedtoboardedit', $projectPlacedToBoardDetail['id']], ['escape' => false]); ?>
                                                        </div>
