...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projectFinancialSanction->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projectFinancialSanction->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="projectFinancialSanctions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Project Financial Sanction') ?></legend>
                <?php
