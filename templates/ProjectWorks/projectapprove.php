				...
				<table id="answerTable" class="table  table-bordered  order-column" style="max-width: 99%;margin-left: 1%;">
					<thead>
						<tr align="center">
							...
							<th style="width:10%">Place Name</th>
					...
					<tfoot>
						<tr>
						   <th colspan="6" style="text-align:right;"><b>Total (in Rs.)</b></th>
			   ...
			   <div class="form-body row">
					<div class="col-md-12">                   
						<div class="form-group row">                        
							...
							<div class="col-md-4">
								<?php echo $this->Form->control('ce_approved', ['class' => 'form-select', 'templates' => ['inputContainer' => '{{content}}'],'empty' => 'select', 'options' => $statusproject, 'label' => false, 'error' => false]); ?>
							</div>
							<label class="control-label col-md-2">Remarks <span
									class="required">  </span></label>
							<div class="col-md-4" >
								<?php echo $this->Form->control('remarks', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'type' => 'textarea', 'rows'=>3,'id'=>'remarks']); ?>
							</div>
						</div>            
				   </div>
				</div>
