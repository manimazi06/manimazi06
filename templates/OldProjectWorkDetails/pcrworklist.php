...
<div class="col-md-12"><?php //echo 'hi'; exit(); ?>
    <div class="card card-topline-aqua">
        	<div class="card-head">
				<header>PCR Works Details</header>	
                     <?php if($role_id == 1){  ?>
				     <div class="tools">
                                    ...
                                    foreach ($oldProjectWorkDetails as $oldProjectWorkDetail) : ?>
                                        <tr class="odd gradeX">
											...
											<?php if($role_id == 9 || $role_id == 14){ ?>
												...
												<?php if($role_id == 9 || $role_id == 14){ ?>
												    <?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Edit'), ['action' => 'pcrbasicdetail',$oldProjectWorkDetail['id']], ['escape' => false, 'class' => 'btn btn-outline-danger btn-sm']); ?>&nbsp;&nbsp;&nbsp;
												<?php }  }else{ 
												 if($role_id == 9 || $role_id == 14){ ?>												 
												    <?php  echo $this->Html->link(__('<i class="fa fa-pencil"></i> Update'), ['action' => 'pcrbasicdetail',$oldProjectWorkDetail['id'],$project[$oldProjectWorkDetail['id']]['project_work_id'],$project[$oldProjectWorkDetail['id']]['id']], ['escape' => false, 'class' => 'btn btn-outline-success btn-sm']); ?><br><br>
