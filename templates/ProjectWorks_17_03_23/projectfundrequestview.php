							 ...
							 <table id="answerTable" class="table  table-bordered  order-column"
								 ...
								 <thead>
									 <tr align="center">
										...
										<th style="width:8%">Area /<br> Place Name</th>
									 ...
									 <tr align="center">
									   <td class="trcount"><?php echo $i+1; ?></td>
										<?php echo $this->Form->control('project.'.$i.'.id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => $projectFundRequestdetail['work_id']]); ?>
										 ...
										 <td><?php echo $projectFundRequestdetail['place_name']; ?></td>
									     ...
									     <?php } ?>
										 <td align="right"><?php echo ($projectFundRequestdetail['final_balance'])?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['final_balance'],'INR'),'₹'):ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['balance_amount'],'INR'),'₹'); ?></td> 
