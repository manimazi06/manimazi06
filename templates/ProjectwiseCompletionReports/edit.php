...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $projectwiseCompletionReport->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $projectwiseCompletionReport->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="projectwiseCompletionReports form content">
            ...
            <fieldset>
                <legend><?= __('Edit Projectwise Completion Report') ?></legend>
                <?php
