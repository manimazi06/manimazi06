                    ...
                    <div class="form-body row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('name', ['class' => 'form-control name titleCase', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Department Name', 'required']); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="control-label col-md-4">Department Code<span class=" required"> *
                                    </span></label>
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('department_code', ['class' => 'form-control Specialfield', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Department Code', 'required']); ?>
                                </div>
                            </div>
                        </div>
...
$("#FormID").validate({
    ...
    messages: {
        ...
        'department_code': {
            required: "Enter Department Code"
        }
    },
