<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Edit Building Item</header>
            </div>
            <div class="card-body">
                    ...
                    <div class="form-body row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <?php echo $this->Form->control('item_code', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Name', 'onblur' => 'code(this.value)','required']); ?>
                                </div>
                            </div>
                        <div class="form-group row">
