<?php 
									 ...
									 <tr align="center">
									   <td class="trcount"><?php echo $i+1; ?></td>
										...
										<?php echo $this->Form->control('project.'.$i.'.subrequest_id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => $projectFundRequestdetail['request_detail_id']]); ?>
										 ...
										 <td align="right"><?php echo ($projectFundRequestdetail['sanctioned_amount'])?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['sanctioned_amount'],'INR'),'₹'):'0.00'; ?></td>
										 <td align="right"><?php echo ($projectFundRequestdetail['balance_payment'])?ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['balance_payment'],'INR'),'₹'):ltrim($fmt->formatCurrency((float)$projectFundRequestdetail['sanctioned_amount'],'INR'),'₹'); ?></td> 
										 ...
										 <td>
										   ...
										   <?php echo $this->Form->control('project.'.$i.'.balance_payment', ['class'=>'division_id','label' => false, 'error' => false, 'type' =>'hidden','value'=> ($projectFundRequestdetail['balance_payment'])?$projectFundRequestdetail['balance_payment']:$projectFundRequestdetail['sanctioned_amount']]) ?>
										...
										<?php  echo $this->Form->control('project1.'.$j.'.request_detail_id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => $projectFundRequestdetail['request_detail_id']]); ?>
									     ...
									     <td align="right"> <?php echo $this->Form->control('project1.'.$j.'.transaction_amount', ['class' => 'form-control amount divided_amount1', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' =>'Request Amount','min'=>1,'maxlength'=>13,'onkeyup'=>'calculateTotal1();calculatebalance1(this.value,'.$j.')','data-rule-required'=>true,'data-msg-required'=>'Enter Request Amount','value'=>0]) ?>
										   ...
										   <?php echo $this->Form->control('project1.'.$j.'.project_id', ['label' => false, 'error' => false, 'type' =>'hidden','value'=> $projectFundRequestdetail['project_work_id']]) ?>
											...
											<?php echo $this->Form->control('project1.'.$j.'.balance_payment', ['class'=>'division_id','label' => false, 'error' => false, 'type' =>'hidden','value'=> ($projectFundRequestdetail['balance_payment'])?$projectFundRequestdetail['balance_payment']:$projectFundRequestdetail['sanctioned_amount']]) ?>
										
										</td>
										<td>
										   <?php echo $this->Form->control('project1.'.$j.'.final_balance', ['class' => 'form-control amount bal_amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' =>'Balance Amount','min'=>0,'maxlength'=>13,'readonly']) ?>
										</td>
 ...
 <?php if($role_id == 8 || ($role_id == 4 && $projectFundRequest['is_approved'] == 1)){ ?>
