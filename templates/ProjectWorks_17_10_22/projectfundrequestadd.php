									   ...
									   <?php
										...
										foreach ($projectworkdetails as $projectWorkSubdetail) : ?>										
										 <tr> 
										   ...
										   <td align="right"><?php echo $projectWorkSubdetail['agreement_amount']; ?></td>										
											
										</tr>
										  <?php
											 $tot_aggrement    += $projectWorkSubdetail['agreement_amount'];
										     $i++;
										     endforeach; ?>
									</tbody>
									<tfoot>
										<tr>
										   ...
										   <td align="right"><b><?php echo $tot_aggrement;  ?></b></td>
										</tr>
									</tfoot>
								</table>
						    </div>			
