         ...
         <div id ="project" style="display:none;"> </div> 
			...
			<div class="card-body">
				 ...
				 <?php if($fundrequestcount > 0){  ?>
				        <fieldset	 style="border:1px solid #00355F;border-radius:10px;padding:15px;margin-left:1px; background-color:ghostwhite;">
											 ...
											 <tr align="center">
											   <td class="trcount"><?php echo $i+1; ?></td>
												 ...
												 <td><?php echo ($fundrequest['transaction_ref_no'] != '')?$fundrequest['transaction_ref_no']:""; ?>
												  ...
												  <td><?php echo ($fundrequest['is_approved'] == 0)?$fundrequest['balance_amount']:$balance_amt; ?>
												 </td>  
				...
				<?php echo $this->Form->control('id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => $currentfundrequest['id']]) ?>
				 ...
				 <?php  if($role_id == 13 && $projectWorkSubdetail['fund_request_flag'] == 0){  ?>
					 ...
					 <div class="col-md-12">
									 ...
									 <table id="answerTable" class="table  table-bordered  order-column"
										 ...
										 <tbody class="add_doc">
											 <tr class="present_row">
												 ...
												 <td>
												 <?php echo $this->Form->control('fund_amount', ['id'=>'fund_amount','class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Amount','required','onblur'=>'calling(this.value)']) ?>
												 </td>                                       
												 <td>
												 <?php echo $this->Form->control('balance_amount', ['id'=>'balance_amount','class' => 'form-control','readonly', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Balance Amount', 'type' => 'text',  'required','readonly']) ?>
												 </td>                                        
												 <td>
					  ...
					  <h4 class = "sub-tile">New Fund Request</h4>
					 <fieldset	 style="border:1px solid #00355F;border-radius:10px;padding:15px;margin-left:1px;margin-bottom:1%">
					     <div class="col-md-12" style="margin-top:">						 
						    <div class="form-group row">
							  <label class="control-label col-md-3 bol">Request Date. <span class="required">* </span></label>
								<div class="col-md-3">
                                 <?php echo $this->Form->control('request_date', ['class' => 'form-control datepicker', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'select Request Date','required']) ?>							   </div>
							  						
							</div>
                             
                            <div class="form-group row">
							  <label class="control-label col-md-3 bol">Request amount(in Rs.)<span class="required">*  </span></label>
								<div class="col-md-3">
								 <?php echo $this->Form->control('fund_amount', ['id'=>'fund_amount','class' => 'form-control amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Enter Amount','required','onblur'=>'calling(this.value)']) ?>
									</div>
							  <label class="control-label col-md-3 bol">Balance Amount (in Rs.) <span class="required">*  </span></label>
								<div class="col-md-3">
								 <?php echo $this->Form->control('balance_amount', ['id'=>'balance_amount','class' => 'form-control','readonly', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Balance Amount', 'type' => 'text',  'required','readonly']) ?>
					  ...
					  <?php }else if(($role_id == 4 ||$role_id == 5 || $role_id == 6) && $currentfundrequest['is_approved'] == 0){ 
				 ...
				 <div class="form-group" style="padding-top: 10px">
					 <div class="offset-md-5 col-md-6">
					   <?php if($role_id == 13 && $projectWorkSubdetail['fund_request_flag'] == 0){  ?>
					   <?php echo $this->Form->control('fund_status_id', ['label' => false, 'error' => false, 'type' => 'hidden','value' => 1]) ?>
						 <button type="submit" class="btn btn-info m-r-20">Forward to EE</button>
					   <?php }else if($role_id == 4 && $currentfundrequest['is_approved'] == 0){  ?> 
