<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Add UC Fund Details</header>
            </div>
            <div class="card-body">
					...
					<h4 class = "sub-tile">UC Details</h4> 
						...
						<div class="col-md-12">
							...
							<label class="control-label col-md-2">Remarks<span class=" required">
                                ...
                                <div class="col-md-4">
                                    <?php echo $this->Form->control('remarks', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'type' => 'textarea', 'rows' => 3, 'label' => false, 'error' => false, 'placeholder' => 'Remarks']); ?>
                                </div>
                            </div>
                        </div>
                        </div>
