...
<tr class="delete_docdetails_class_<?php echo $id ?> present_row">
   ...
   <td align="right"><?php echo $projectWorkSubdetail[0]['agreement_amount']; ?></td>
   <td align="right"><?php echo ($projectWorkSubdetail[0]['balance_payment'])?$projectWorkSubdetail[0]['balance_payment']:$projectWorkSubdetail[0]['agreement_amount']; ?></td>
 	<td>
	...
	<td>
       <?php echo $this->Form->control('project.'.$i.'.balance_amount', ['class' => 'form-control amount bal_amount', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' =>'Balance Amount','min'=>1,'maxlength'=>13,'readonly']) ?>
  	</td>	
    ...
    <?php echo $this->Form->control('project.'.$i.'.balance_payment', ['class'=>'division_id','label' => false, 'error' => false, 'type' =>'hidden','value'=> ($projectWorkSubdetail[0]['final_balance'])?$projectWorkSubdetail[0]['final_balance']:$projectWorkSubdetail[0]['agreement_amount']]) ?>
