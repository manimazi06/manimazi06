                    ...
                    <div class="col-md-12">
					   <fieldset	 style="border:1px solid #00355F;border-radius:10px;padding:15px;margin-left:1px;margin-bottom:1%">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3">Work Name <span class="required"> * </span></label>
                            <div class="col-md-9">
                                <?php echo $this->Form->control('work_name', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'type' => 'textarea', 'rows' => 2, 'error' => false, 'placeholder' => 'Enter Work Description', 'required']); ?>
                            </div>
                            <!--label class="control-label col-md-2">Description<span class="required"> * </span></label>
                            <div class="col-md-4">
                                <?php echo $this->Form->control('work_description', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'type' => 'textarea', 'rows' => 2, 'error' => false, 'placeholder' => 'Enter Description', 'required']); ?>
                            </div-->
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-md-3 ">Estimated Cost (in Rs.)<span class="required"> * </span></label>
                            <div class="col-md-3">
                                                ...
                                                foreach ($ProjectwiseDevelopmentWorkslists as $ProjectwiseDevelopmentWorkslist) : ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Edit'), ['action' => 'edit',$pid,$work_id,$id, $ProjectwiseDevelopmentWorkslist['id']], ['escape' => false, 'class' => 'btn btn-outline-primary btn-sm']); ?><br></br>
                                                            <?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Update Details'), ['action' => 'projectdetailedestimate',$ProjectwiseDevelopmentWorkslist['id'],$pid,$work_id ], ['escape' => false, 'class' => 'btn btn-outline-danger btn-sm']); ?><br></br>
                                                           	  <?php  echo $this->Html->link(__('<i class="fa fa-pencil"></i> Contractor Rate'), ['action' => 'contractorratedetails',$ProjectwiseDevelopmentWorkslist['id'],$pid,$work_id], ['escape' => false, 'class' => 'btn btn-outline-info btn-sm']); ?><br><br>
