											...
											<span>
											 ...
											 <?php //} ?>	
											   ...
											   <?php if($type ==1){ ?>
												...
												<?php   if($projectWorkSubdetail['detailed_estimate_current_role'] == 6){ ?>	   	
												  <?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Abstract Approval'), ['action' => 'projectabstractapproval',$projectWorkSubdetail['project_work_id'],$projectWorkSubdetail['id']], ['escape' => false, 'class' => 'btn btn-outline-danger btn-sm']); ?><br><br>
										       <?php } } ?> 
											   <?php if($projectWorkSubdetail['detailed_estimate_flag'] == 0 && $role_id == 14){ ?>
											   	<?php echo $this->Html->link(__('<i class="fa fa-pencil"></i> Add Abstract'), ['action' => 'projectabstractadd',$projectWorkSubdetail['project_work_id'],$projectWorkSubdetail['id']], ['escape' => false, 'class' => 'btn btn-outline-danger btn-sm']); ?><br><br>
