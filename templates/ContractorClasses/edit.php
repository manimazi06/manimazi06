<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>Edit Contractor class </header>
            </div>
            <div class="card-body">
                <?php echo $this->Form->create($contractorClass, ['id' => 'FormID', 'class' => 'form-horizontal', "autocomplete" => "off", 'enctype' => 'multipart/form-data']); ?>
                <div class="col-md-10 offset-2">
                    <div class="form-body row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-4">Monetary Value<span class=" required"> 
                                    </span></label>
                                <div class="col-md-6">
                                    <?php echo $this->Form->control('monetary_value', ['class' => 'form-control', 'templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'error' => false, 'placeholder' => 'Monetary Value', 'required']); ?>
                                </div>
                            </div>
                        </div>                  
