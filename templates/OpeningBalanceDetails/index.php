...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <div class="card-head">
                <header>PD Account Balance Details</header>
				<div class="tools">
				   <?php if ($openingBalanceDetailcount == 0) { ?>
			 		  <?php echo $this->Html->link(__('Add PD Balance<i class="fa fa-plus"></i>'), ['action' => 'openingbalance'], ['escape' => false, 'class' => ' btn btn-info']); ?>
				   <?php } ?>
				</div>
            </div>
            <div class="card-body ">
                                ...
                                <div class="card-body">                                
                                    <div class="table-scrollable">
                                        <table class="table  table-bordered table-checkable order-column" style="width: 100%" id="example4">
                                            ...
                                            <tbody>
                                                <?php $sno = 1; //print_r($openingBalanceDetails); 
													foreach($openingBalanceDetails as $openingBalanceDetail){?>

                                                <tr class="odd gradeX">
                                                    <td class="text-center"><?php echo $sno; ?></td>
                                                    <td class="text-center"><?php echo $openingBalanceDetail['office']['name']; ?></td>
                                                    <td class="text-center"><?php echo $openingBalanceDetail['opening_balance']; ?></td>
                                                    <!--td class="text-center">
													<?php /*if($role_id == 16){ ?>  
													<?php //if($role_id == 8  || $openingBalanceDetail['created_by'] == $user_id){ ?>
                                            ...
                                            </svg><!--end::Svg Icon--></span>'), ['action' => 'openingbalance', $openingBalanceDetail['id']], ['escape' => false]); ?>
                                                        </div>
													<?php }*/ ?>
                                                    </td-->
                                                </tr>
